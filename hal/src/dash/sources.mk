...
HAL_SRC_DASH_PATH = $(TARGET_HAL_PATH)/src/dash
...
INCLUDE_DIRS += $(addprefix $(HAL_SRC_DASH_PATH)/,$(sort $(HAL_WICED_INCLUDE_DIRS)))
INCLUDE_DIRS += $(dir $(call rwildcard,$(HAL_SRC_DASH_PATH)/wiced/security,*.h))
INCLUDE_DIRS += $(dir $(call rwildcard,$(HAL_SRC_DASH_PATH)/wiced/WWD,*.h))
INCLUDE_DIRS += $(HAL_SRC_STM32F2XX_PATH)

CSRC += $(call target_files,$(HAL_SRC_DASH_PATH)/,*.c)
CPPSRC += $(call target_files,$(HAL_SRC_DASH_PATH)/,*.cpp)
